...
#define MyAppWotVersion "1.4.0.2"
...
#define MyAppVersion '1.140.' + Str(BuildNum)
...
Source: pack\Contour Icons\Korolins (DMVK)\1.4.0.2\mod\gui\flash\atlases\battleAtlas.png; Components: xvm; DestDir: {app}\res_mods\{#MyAppWotVersion}\gui\flash\atlases
Source: pack\Contour Icons\Korolins (DMVK)\1.4.0.2\mod\gui\flash\atlases\battleAtlas.dds; Components: xvm; DestDir: {app}\res_mods\{#MyAppWotVersion}\gui\flash\atlases
Source: pack\Contour Icons\Korolins (DMVK)\1.4.0.2\mod\gui\flash\atlases\battleAtlas.xml; Components: xvm; DestDir: {app}\res_mods\{#MyAppWotVersion}\gui\flash\atlases

Source: pack\SessionStat\res_mods\1.4.0.1\scripts\client\gui\mods\BBModsSDK.pyc; Components: session; DestDir: {app}\res_mods\{#MyAppWotVersion}\scripts\client\gui\mods
Source: pack\SessionStat\res_mods\1.4.0.1\scripts\client\gui\mods\mod_TimeSpent.pyc; Components: session; DestDir: {app}\res_mods\{#MyAppWotVersion}\scripts\client\gui\mods
...
Source: pack\Live WN8\mods\1.4.0.0\izeberg.modsettingsapi_1.1.4.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\Live WN8\mods\1.4.0.0\poliroid.modslistapi_1.1.5.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\Live WN8\mods\1.4.0.0\tv.protanki.efficiency_1.0.1.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
...
Source: pack\InfoPanel\mods\1.4.0.0\izeberg.modsettingsapi_1.1.4.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\InfoPanel\mods\1.4.0.0\poliroid.modslistapi_1.1.5.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\InfoPanel\mods\1.4.0.0\tv.protanki.infopanel.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
...
Source: pack\Marksongun\mods\1.3.0.1\mod_mods_gui_2.15.wotmod; DestDir: {app}\mods\{#MyAppWotVersion}; Components: battle\moe
Source: pack\Marksongun\mods\1.3.0.1\spoter\spoter.marksOnGunExtended_5.06.wotmod; DestDir: {app}\mods\{#MyAppWotVersion}\spoter\; Components: battle\moe
Source: pack\Marksongun\mods\1.3.0.1\gambiter.guiflash_0.2.5.1.wotmod; DestDir: {app}\mods\{#MyAppWotVersion}; Components: battle\moe
