...
#define MyAppWotVersion "1.6.0.1"
...
#define MyAppVersion '1.160.' + Str(BuildNum)
...
Source: pack\Contour Icons\Korolins (DMVK)\1.6.0.1\mod\gui\flash\atlases\battleAtlas.png; Components: xvm; DestDir: {app}\res_mods\{#MyAppWotVersion}\gui\flash\atlases
Source: pack\Contour Icons\Korolins (DMVK)\1.6.0.1\mod\gui\flash\atlases\battleAtlas.dds; Components: xvm; DestDir: {app}\res_mods\{#MyAppWotVersion}\gui\flash\atlases
Source: pack\Contour Icons\Korolins (DMVK)\1.6.0.1\mod\gui\flash\atlases\battleAtlas.xml; Components: xvm; DestDir: {app}\res_mods\{#MyAppWotVersion}\gui\flash\atlases
...
Source: pack\Live WN8\mods\1.6.0.0\izeberg.modsettingsapi_1.2.0.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\Live WN8\mods\1.6.0.0\poliroid.modslistapi_1.2.3.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\Live WN8\mods\1.6.0.0\tv.protanki.efficiency_1.4.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
...
Source: pack\InfoPanel\mods\1.6.0.0\izeberg.modsettingsapi_1.2.0.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\InfoPanel\mods\1.6.0.0\poliroid.modslistapi_1.2.3.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\InfoPanel\mods\1.6.0.0\tv.protanki.infopanel.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
...
Source: pack\Marksongun\mods\1.6.0.0\mod_mods_gui_2.20.wotmod; DestDir: {app}\mods\{#MyAppWotVersion}; Components: battle\moe
Source: pack\Marksongun\mods\1.6.0.0\spoter\spoter.marksOnGunExtended_7.07.wotmod; DestDir: {app}\mods\{#MyAppWotVersion}\spoter\; Components: battle\moe
Source: pack\Marksongun\mods\1.6.0.0\gambiter.guiflash_0.3.1.wotmod; DestDir: {app}\mods\{#MyAppWotVersion}; Components: battle\moe
