...
#define MyAppWotVersion "1.11.1.0"
...
#define MyAppVersion '1.111.' + Str(BuildNum)
...
Source: pack\Live WN8\mods\1.11.1.0\tv.protanki.efficiency_2.7.wotmod; Components: battle\igwn8; DestDir: {app}\mods\{#MyAppWotVersion}
...
Source: pack\InfoPanel\mods\1.11.1.0\izeberg.modsettingsapi_1.3.1.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\InfoPanel\mods\1.11.1.0\poliroid.modslistapi_1.3.7.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
Source: pack\InfoPanel\mods\1.11.1.0\tv.protanki.infopanel.wotmod; Components: battle\infopanel; DestDir: {app}\mods\{#MyAppWotVersion}
