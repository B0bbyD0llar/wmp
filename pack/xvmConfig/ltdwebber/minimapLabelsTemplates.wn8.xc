 ...
 */
{
  ...
  "def": {
    ...
    "vehicleSpotted": {
      "$ref": { "path":"def.defaultItem" },
      "flags": [ "ally", "enemy", "squadman", "teamKiller", "spotted", "alive" ],
      "format": "<font size='7' color='{{.minimap.labelsData.colors.txt.{{sys-color-key}}}}'>{{vehicle}}</font><font size='5' color='{{c:xwn8}}'>({{xwn8}})</font>",
      "x": 2,
      "y": -1
    },
   // Player nickname, visible
    ...
    "nickSpotted": {
      ...
      "format": "<font size='7' color='{{.minimap.labelsData.colors.txt.{{sys-color-key}}}}'><i>{{name%.8s~..}}</i></font>",
      "x": 2,
      "y": -9
    },
    ...
    "vehicleLost": {
      "$ref": { "path":"def.defaultItem" },
      "flags": [ "ally", "enemy", "squadman", "teamKiller", "lost", "alive" ],
      "format": "<font size='7' color='{{.minimap.labelsData.colors.txt.{{sys-color-key}}}}'><i>{{vehicle}}</i></font><font size='5' color='{{.minimap.labelsData.colors.txt.{{sys-color-key}}}}'><i>({{xwn8}})</i></font>",
      "alpha": 85,
      "x": 2,
      "y": -1
    },
    ...
    "vtypeDead": {
      ...
      "shadow": { "$ref": { "path":"def.defaultItem.shadow" }, "strength": 2 },
      "align": "center",
      "valign": "center",
      "alpha": 90
    },
