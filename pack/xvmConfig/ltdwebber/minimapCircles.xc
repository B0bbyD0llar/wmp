 ...
 */
{
    "circles": {
        ...
        "view": [
            // Main circles:
			// Основные круги:
			{ "enabled":  true, "distance": "blindarea", "scale": 1, "thickness": 0.6, "alpha": 80, "color": "0x3EB5F1" },
            { "enabled":  true, "distance": 445,         "scale": 1, "thickness": 0.6, "alpha": 65, "color": "0xFFCC66" },
            // Circle of the maximum units appearance.
            // Окружность границы максимальной отрисовки юнитов.
            { "enabled": true, "distance": 564,         "scale": 1, "thickness":  0.7, "alpha": 65, "color": "0xB30000" },
            // Additional circles:
            // Дополнительные круги:
            { "enabled":  true, "distance": 50,          "scale": 1, "thickness": 0.5, "alpha": 50, "color": "0xFFFFFF" },
            { "enabled":  true, "distance": "standing",  "scale": 1, "thickness": 0.5, "alpha": 50, "color": "0x8888FF" },
            { "enabled":  true, "distance": "motion",    "scale": 1, "thickness": 0.5, "alpha": 50, "color": "0x8888FF" },
            { "enabled":  true, "distance": "dynamic",   "scale": 1, "thickness": 0.6, "alpha": 65, "color": "0x00BBFF" }
        ],
        ...
        "artillery": { "enabled": true, "alpha": 65, "color": "0xEE4444", "thickness": 0.5 },
        // Maximum range of shooting for machine gun
        // Максимальная дальность полета снаряда для пулеметных танков
        "shell":     { "enabled": true, "alpha": 65, "color": "0xEE4444", "thickness": 0.5 },
